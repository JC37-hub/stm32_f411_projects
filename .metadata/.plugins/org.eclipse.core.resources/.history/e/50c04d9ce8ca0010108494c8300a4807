...
int main(void)
{
  ...
  while (1)
  {
	// 1. Cambiar el estado del pin PC13 (el LED)
	// HAL_GPIO_TogglePin es una macro de la HAL que invierte el estado actual del pin.
	// Usamos el nombre que definimos en CubeMX (LED_ONBOARD_GPIO_Port, LED_ONBOARD_Pin)
